...
$(document).ready(function(){
  ...
  if ($('#nav-menu-container').length) {
    ...
    $('body').prepend('<button type="button" style="margin-top:-24px;" class="btn btn-lg" id="mobile-nav-toggle"><i class="lnr lnr-menu" style="font-size:1.8em;"></i></button>');
  ...
  $(window).scroll(function() {
    ...
    var countDownDate = new Date("Mar 7 , 2019 09:00:00").getTime();
